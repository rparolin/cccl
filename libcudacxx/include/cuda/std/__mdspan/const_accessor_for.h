...
{
  using type _CCCL_NODEBUG_ALIAS = typename _A::const_accessor_type;
};
...
{
  using type _CCCL_NODEBUG_ALIAS = _Tmpl<add_const_t<_T>, _Rest...>;
};

template <class _A>
using const_accessor_for_t _CCCL_NODEBUG_ALIAS = typename const_accessor_for<_A>::type;

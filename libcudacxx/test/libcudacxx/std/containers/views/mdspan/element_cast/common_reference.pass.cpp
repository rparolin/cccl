...
// ---------------------------------------------------------------------------
//
// Specializations of std::basic_common_reference are permitted for user
// types under the usual constraints; the specializations here are
// expressed in cuda::std per libcudacxx conventions. The exact
// common-reference type chosen (plain T) is one reasonable answer; the
// paper's R1 wording will refine the choice across all cases.
